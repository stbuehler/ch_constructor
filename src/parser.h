...
namespace Parser {
	...
	template <typename NodeT, typename EdgeT>
	bool readSTD(InData<NodeT,EdgeT>& data, std::string const& filename);
	template <typename NodeT, typename EdgeT>
	bool writeSTD(OutData<NodeT,EdgeT> data, std::string const& filename);
	template <typename NodeT, typename EdgeT>
	bool readSIMPLE(InData<NodeT,EdgeT>& data, std::string const& filename);
	template <typename NodeT, typename EdgeT>
	bool writeSIMPLE(OutData<NodeT,EdgeT> data, std::string const& filename);
	template <typename NodeT, typename EdgeT>
	bool readFMI(InData<NodeT,EdgeT>& data, std::string const& filename);
	template <typename NodeT, typename EdgeT>
	bool writeFMI_CH(OutData<NodeT,EdgeT> data, std::string const& filename);

	template <typename NodeT, typename EdgeT>
	bool read(InData<NodeT,EdgeT>& data, std::string const& filename,
			FileFormat format);

	template <typename NodeT, typename EdgeT>
	bool write(OutData<NodeT,EdgeT> data, std::string const& filename,
			FileFormat format);
	...
	struct OutData
	{
		...
		OutData(std::vector<NodeT> const& nodes, std::vector<EdgeT> const& edges)
